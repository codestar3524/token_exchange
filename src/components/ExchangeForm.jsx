...
const ExchangeForm = () => {
  ...
  return (
    <>
      <form className="exchange-form" onSubmit={handleSubmit}>
        ...
        <div className="exchange-wrapflex">
          <div className="exchange-option">
            ...
            <span id="type_difference" className="exchange-option-diff" onClick={toggleDifference}>
      ...
      {showDifferenceModal && <FloatModal active={showDifferenceModal} closeModal={closeModal} />}
      </>
  );
};
